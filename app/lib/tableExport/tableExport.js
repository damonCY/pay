 ...
 * tableExport lib
 * 
 * @author  Yang,junlong at 2016-09-20 21:08:49 build.
 * @version $Id$
 */
var jQuery = require('/mix/lib/jquery/jquery.js');
    ...
    tableExport: function (options) {
      ...
      if (defaults.type == 'csv' || defaults.type == 'txt') {
        ...
        $tables.each(function(){
          ...
          docData += '<table><thead>';
          // Header
          $hrows = $(this).find('thead').first().find(defaults.theadSelector).show();
          $hrows.each(function() {
            trData = "";
            ForEachVisibleCell(this, 'th,td', rowIndex, $hrows.length,
              function(cell, row, col) {
          ...
          docData += '</thead><tbody>';
          // add by yang,junlong at 2016-10-26
          $(this).find('thead').first().find('tr.__meta').hide();
          // Row Vs Column
