...
app.registerController('outeraccountCtrl', ['$rootScope', '$scope', '$http', '$modal', '$state', '$stateParams', '$sce', 'dateFilter',
    function($rootScope, $scope, $http, $modal, $state, $stateParams, $sce, dateFilter) {
    $scope.title = '清算报表/账户余额(外部)';
    $scope.titleIcon = '';
    $scope.queryParams = {
    ...
    $scope.search = function() {
        $state.go('balance.outeraccount', $scope.queryParams, {
            reload: true
        });
    }
}]);
